package com.company.assembleegameclient.util
{
   ...
   public class FameUtil
   {
      ...
      public static const STARS:Vector.<int> = new <int>[20,150,400,800];
      ...
      public static function numStars(level:int) : int
      {
         var num:int = 0;
         while(num < STARS.length && level >= STARS[num])
         {
            num++;
         }
         return num;
      ...
      public static function nextStarFame() : int
      {
          return 5;
      }
