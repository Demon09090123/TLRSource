package com.company.assembleegameclient.screens
{
   ...
   public class CharacterBox extends Sprite
   {
      ...
      public function CharacterBox(playerXML:XML, model:PlayerModel)
      {
         ...
         stars = this.getStars(FameUtil.numStars(model.getLevel()),FameUtil.STARS.length);
         stars.y = 60;
      ...
      {
         return new ClassToolTip(this.playerXML_,this.model);
      }
