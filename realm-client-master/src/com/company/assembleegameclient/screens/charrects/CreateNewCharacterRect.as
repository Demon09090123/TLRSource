...
import flash.filters.GlowFilter;
   ...
   public class CreateNewCharacterRect extends Sprite
   {
      ...
      public function CreateNewCharacterRect()
      {
          drawButtons();
      ...
      private function drawButtons():void {
          ...
          this.selectBtn = new TitleMenuOption("SELECT", 18, false, true);
          ...
          this.titleLine.graphics.lineTo(CharacterList.WIDTH, 45);
          this.btnBG.graphics.beginFill(0, .8);
          this.btnBG.graphics.drawRect(0, 0, CharacterList.WIDTH, 40);

          this.titleTxt.x = (CharacterList.WIDTH - this.titleTxt.width) / 2;
          this.titleTxt.y = 10;

          this.selectBtn.x = (CharacterList.WIDTH - this.selectBtn.width) / 2;
      ...
      private function setSelected(index:int):void {
          ...
          this.centerBitmap.x = (CharacterList.WIDTH - this.centerBitmap.width) / 2 + 12;
