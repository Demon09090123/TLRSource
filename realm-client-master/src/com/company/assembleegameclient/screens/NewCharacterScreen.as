...
import flash.display.Sprite;
   ...
   public class NewCharacterScreen extends Sprite
   {
      ...
      public function initialize(model:PlayerModel) : void
      {
         ...
         this.creditDisplay_.draw(model.getCredits());
         ...
         for(var i:int = 0; i < ObjectLibrary.playerChars_.length; i++)
         {
            ...
            charBox = new CharacterBox(playerXML, model);
      ...
      public function updateCreditsAndFame(credits:int) : void
      {
         this.creditDisplay_.draw(credits);
      }
   }
}
