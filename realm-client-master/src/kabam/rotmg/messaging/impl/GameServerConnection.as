...
import kabam.rotmg.ui.view.MessageCloseDialog;
   ...
   public class GameServerConnection
   {
      ...
      public function GameServerConnection(gs:GameSprite, gameId:int, createCharacter:Boolean, mapJSON:String)
      {
         super();
      ...
      private function onReconnect(reconnect:Reconnect) : void
      {
         ...
         var reconnectEvent:ReconnectEvent = new ReconnectEvent(gameID,createChar);
