...
import kabam.rotmg.ui.characterView.mediator.CharacterScreenSelectionMediator;
...
import kabam.rotmg.ui.characterView.mediator.CurrentCharacterMediator;
import kabam.rotmg.ui.characterView.mediator.NewCharacterMediator;
...
import org.swiftsuspenders.Injector;
   ...
   public class UIConfig implements IConfig
   {
      ...
      public function configure() : void
      {
         ...
         this.mediatorMap.map(CharacterSelectionAndNewsScreen).toMediator(CharacterScreenSelectionMediator);
         this.mediatorMap.map(NewCharacterScreen).toMediator(NewCharacterMediator);
         this.mediatorMap.map(CurrentCharacterScreen).toMediator(CurrentCharacterMediator);
